  ...
  methods: {
    trophyNumStyle(rank){
      if(rank === 2 || rank === 3){
        ...
        return { transform: 'translate(-6px, -7px)', pointerEvents: 'none' }
      }
      return {}
    },
    selectClass(cls) {
...
.trophy_2 .trophy_num,
.trophy_3 .trophy_num{ transform: translate(-4px, -7px) !important }

@media(max-width:760px){
  .trophy_2 .trophy_num,
  .trophy_3 .trophy_num{ transform: translate(-6px, -7px) !important }
}
