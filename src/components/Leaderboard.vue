            ...
            <tr v-else v-for="(row, i) in first_rows" :key="'f'+i" :class="row.row_class">
              ...
              <td class="rank">
                <span v-if="i < 3" class="trophy" :class="'trophy_' + (i+1)">
                  ...
                  <span class="trophy_num" aria-hidden="true" :style="(i+1===2||i+1===3)?{transform:'translate(2px, -6px)'}:{}">{{ i + 1 }}</span>
                </span>
            ...
            <div class="row_grid" v-for="(row, j) in extra_rows" :key="'x'+j" :class="row.row_class">
              ...
              <div class="cell rank">
                <span v-if="first_rows_count + j + 1 <= 3" class="trophy" :class="'trophy_' + (first_rows_count + j + 1)">
                  ...
                  <span class="trophy_num" aria-hidden="true" :style="(first_rows_count + j + 1===2||first_rows_count + j + 1===3)?{transform:'translate(2px, -6px)'}:{}">{{ first_rows_count + j + 1 }}</span>
                </span>
